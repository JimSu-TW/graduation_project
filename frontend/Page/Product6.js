...
const API_Post = "http://127.0.0.1:5000/api/iphone12mini/phonepost";
const API_FtBudget = "http://127.0.0.1:5000/api/iphone12mini/feature/budget";
const API_FtWafer = "http://127.0.0.1:5000/api/iphone12mini/feature/wafer";
const API_FtScreen = "http://127.0.0.1:5000/api/iphone12mini/feature/screen";
const API_FtBattery = "http://127.0.0.1:5000/api/iphone12mini/feature/battery";
const API_FtLens = "http://127.0.0.1:5000/api/iphone12mini/feature/lens";
const API_FtCapacity = "http://127.0.0.1:5000/api/iphone12mini/feature/capacity";
                ...
                <div className="col-lg-5 pb-5">
                    <div className="border mt-5">
                        <div className="active mx-5 my-5 ">
                            <img src={require("./images/popularph/ph6.jpg")} alt="ph1" className="img_banner w-100 h-100"></img>
                        </div>
                    </div>
                </div>
                <div className="col-lg-7 pb-2">
                    <header className="px-5">
                        <span className="px-2"><h2 className="font-weight-semi-bold mb-1 text-center">iPhone 12 mini</h2></span>
                    </header>
                                    ...
                                    <div className="tab-pane show" id="tab-pane-1">
                                        <div className="attributesArea">
                                            <div>
                                                ...
                                                <tr>
                                                    <th><p>機身顏色</p></th>
                                                    <td><p>藍色、綠色、黑色、白色與 (PRODUCT)RED</p></td>
                                                </tr>
                                                </tbody>
                                                </table>
                                            </div>
