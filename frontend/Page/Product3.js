...
const API_Post = "http://127.0.0.1:5000/api/iphone13/phonepost";
const API_FtBudget = "http://127.0.0.1:5000/api/iphone13/feature/budget";
const API_FtWafer = "http://127.0.0.1:5000/api/iphone13/feature/wafer";
const API_FtScreen = "http://127.0.0.1:5000/api/iphone13/feature/screen";
const API_FtBattery = "http://127.0.0.1:5000/api/iphone13/feature/battery";
const API_FtLens = "http://127.0.0.1:5000/api/iphone13/feature/lens";
const API_FtCapacity = "http://127.0.0.1:5000/api/iphone13/feature/capacity";
                ...
                <div className="col-lg-5 pb-5">
                    <div className="border mt-5">
                        <div className="active mx-5 my-5 ">
                            <img src={require("./images/popularph/ph3.jpg")} alt="ph1" className="img_banner w-100 h-100"></img>
                        </div>
                    </div>
                </div>
                <div className="col-lg-7 pb-2">
                    <header className="px-5">
                        <span className="px-2"><h2 className="font-weight-semi-bold mb-1 text-center">iPhone 13</h2></span>
                    </header>
