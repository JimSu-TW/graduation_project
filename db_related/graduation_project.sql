...
-- -----------------------------------------------------
-- Schema GraduationProjectDB
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema GraduationProjectDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `GraduationProjectDB` DEFAULT CHARACTER SET utf8 ;
USE `GraduationProjectDB` ;

-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_source`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_source` (
...
-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_icon`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_icon` (
...
-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_product_class`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_product_class` (
...
-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_brand`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_brand` (
...
-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_product` (
  ...
  CONSTRAINT `icon_to_product_fk`
    FOREIGN KEY (`icon_id`)
    REFERENCES `GraduationProjectDB`.`tbl_icon` (`icon_id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `product_class_to_product_id`
    FOREIGN KEY (`product_class_id`)
    REFERENCES `GraduationProjectDB`.`tbl_product_class` (`product_class_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `brand_to_product_fk`
    FOREIGN KEY (`brand_id`)
    REFERENCES `GraduationProjectDB`.`tbl_brand` (`brand_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_post`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_post` (
  ...
  CONSTRAINT `source_to_post_fk`
    ...
    REFERENCES `GraduationProjectDB`.`tbl_source` (`source_id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `product_to_post_fk`
    FOREIGN KEY (`product_id`)
    REFERENCES `GraduationProjectDB`.`tbl_product` (`product_id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_label`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_label` (
...
-- -----------------------------------------------------
-- Table `GraduationProjectDB`.`tbl_label_datail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GraduationProjectDB`.`tbl_label_datail` (
  ...
  CONSTRAINT `label_to_label_detail_fk`
    ...
    REFERENCES `GraduationProjectDB`.`tbl_label` (`label_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
